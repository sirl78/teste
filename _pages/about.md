...
[av_heading tag='h1' padding='10' heading='EcoNet™' color='custom-color-heading' style='blockquote modern-quote modern-centered' custom_font='#ffffff' size='' subheading_active='' subheading_size='30' custom_class='portfoliocaption'][/av_heading]

[av_hr class='custom' height='50' shadow='no-shadow' position='center' custom_border='av-border-thin' custom_width='25%' custom_border_color='#ffffff' custom_margin_top='10px' custom_margin_bottom='10px' icon_select='no' custom_icon_color='' icon='ue808' font='entypo-fontello' custom_class='']
